  ...
  return name
    ...
    return(
     <div className={` ${Styles.SingleCountry} ${Styles[theme]}`}>
      <img src={props.country.flags.png} alt={`country Name : ${props.country.name}`}  />
          ...
          <div className={Styles.countryData}>
             ...
             <div className={Styles.dataArea}>
              <div>
              <p><span>Native Name : </span>{props.country.nativeName}</p>
              <p><span>Population : </span>{props.country.population.toLocaleString("en")}</p>
               <p><span>Region : </span>{props.country.region}</p>
               <p><span>Subregion : </span>{props.country.subregion}</p>
              ...
              <div>
               <p className={Styles.topLevel}><span>Top Level Dmain : </span>{props.country.topLevelDomain}</p>
               {props.country.currencies && 
                 <p><span>Currencie : </span>{props.country.currencies.map(item => item.name)}</p>
               }
               <p ><span>Languages : 
                </span>{props.country.languages.map((item,index)=>(<span key={index} className={Styles.language}>
                  {` ${item.name}`}</span>))}</p>
              </div>
              </div> 
          <div className={Styles.borderArea}>
            ...
            <div className={`${Styles.borders} ${Styles[theme]}`}>
              ...
              <Link to={`/country/${borderCode}` } key={index} className={Styles.singleBorder}>
               <span className={Styles[theme]}>{ getNameByCode(borderCode) } </span> </Link>
              ))}
            </div>
          </div>   
          </div> 
